...
1. Install {gt} from GitHub (recommended)
    ...
    ```
    - If you experience issues installing {gt} on Windows, download and install [Rtools from CRAN](https://cran.r-project.org/bin/windows/Rtools/), restart R, and attempt installation again.
