...
You can install the production version of {gtsummary} with the following code.  It is recommended to install the {gt} package with {gtsummary}.  The {gt} package enhances the output tables.  If {gt} is not installed, `knitr::kable()` will be used instead.
