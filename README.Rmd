...
Use [`tbl_summary()`](http://www.danieldsjoberg.com/gtsummary/reference/tbl_summary.html) to summarize a data frame. [Example](https://github.com/ddsjoberg/gtsummary/blob/master/data-raw/misc_files/tbl_summary_demo1.gif)
