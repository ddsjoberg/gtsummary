...
* Automatically reduced vertical white space between columns for compact flextable theme. Allowed modification to font_size for compact flextable, huxtable, and kableExtra theme. (NEED TO ADD IN NUMBER)
