...
* Automatically reduced vertical white space between columns for compact flextable theme. Allowed modification to font_size for compact flextable and huxtable compact theme. (NEED TO ADD IN NUMBER)
