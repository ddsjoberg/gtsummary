...
* New function added, `as_flextable()`! The function converts gtsummary objects to flextable objects, and is a good option when using R markdown with Miscrosoft Word output as flextable support indentation, footnotes, and spanning headers.
