...
**Note::** for more advanced and nicely formatted plots of model coefficients, look at `GGally::ggcoef_model()` and its [dedicated vignette](https://ggobi.github.io/ggally/articles/ggcoef_model.html). `GGally::ggcoef_model()` internally uses `broom.helpers`.
