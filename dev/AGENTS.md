...
[`.github/CONTRIBUTING.md`](https://www.danieldsjoberg.com/gtsummary/dev/CONTRIBUTING.md);
...
- Honor
  [`.github/PULL_REQUEST_TEMPLATE.md`](https://www.danieldsjoberg.com/gtsummary/dev/PULL_REQUEST_TEMPLATE.md);
...
- **Performance-sensitive PRs:** if a change may affect package
  ...
  `.github/scripts/benchmark.R` to compare PR-vs-`main` timings on
  representative pipelines (`tbl_summary`, `tbl_hierarchical`) and posts
  a benchmark report as a PR comment.
