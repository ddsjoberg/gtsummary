...
\# Example 2 ---------------------------------- trial \|\>
[tbl_cross](https://www.danieldsjoberg.com/gtsummary/reference/tbl_cross.md)(row
= stage, col = trt) \|\>
[add_p](https://www.danieldsjoberg.com/gtsummary/reference/add_p.md)(source_note
= TRUE)
