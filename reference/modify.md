...
## [`tbl_summary()`](https://www.danieldsjoberg.com/gtsummary/reference/tbl_summary.md), [`tbl_svysummary()`](https://www.danieldsjoberg.com/gtsummary/reference/tbl_svysummary.md), and [`tbl_cross()`](https://www.danieldsjoberg.com/gtsummary/reference/tbl_cross.md)
...
spanning header tbl \|\>
modify_header([all_stat_cols](https://www.danieldsjoberg.com/gtsummary/reference/select_helpers.md)()
~ "\*\*{level}\*\*, N = {n} ({style_percent(p)}%)") \|\>
modify_spanning_header([all_stat_cols](https://www.danieldsjoberg.com/gtsummary/reference/select_helpers.md)()
~ "\*\*Treatment Received\*\*")
