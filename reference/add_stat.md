...
3.  Each function may take the following arguments:
    ...
    - `tbl=` the original
      [`tbl_summary()`](https://www.danieldsjoberg.com/gtsummary/reference/tbl_summary.md)/[`tbl_svysummary()`](https://www.danieldsjoberg.com/gtsummary/reference/tbl_svysummary.md)
...
my_ttest2) \|\>
[modify_header](https://www.danieldsjoberg.com/gtsummary/reference/modify.md)(add_stat_1
...
[everything](https://tidyselect.r-lib.org/reference/everything.html)() ~
my_ttest3) \|\>
[modify_header](https://www.danieldsjoberg.com/gtsummary/reference/modify.md)(statistic
= "\*\*t-statistic\*\*", p.value = "\*\*p-value\*\*") \|\>
[modify_fmt_fun](https://www.danieldsjoberg.com/gtsummary/reference/modify_fmt_fun.md)(statistic
=
[label_style_sigfig](https://www.danieldsjoberg.com/gtsummary/reference/label_style.md)(),
p.value =
[label_style_pvalue](https://www.danieldsjoberg.com/gtsummary/reference/label_style.md)(digits
= 2))
