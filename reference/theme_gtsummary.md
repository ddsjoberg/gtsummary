...
- `theme_gtsummary_journal(journal)`
  ...
  - `"jama"` *The Journal of the American Medical Association*
    ...
    - [`tbl_regression()`](https://www.danieldsjoberg.com/gtsummary/reference/tbl_regression.md)/[`tbl_uvregression()`](https://www.danieldsjoberg.com/gtsummary/reference/tbl_uvregression.md)
