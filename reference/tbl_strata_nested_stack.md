...
[tbl_summary](https://www.danieldsjoberg.com/gtsummary/reference/tbl_summary.md)(include
= [c](https://rdrr.io/r/base/c.html)(age, grade), missing = "no") \|\>
[modify_header](https://www.danieldsjoberg.com/gtsummary/reference/modify.md)([all_stat_cols](https://www.danieldsjoberg.com/gtsummary/reference/select_helpers.md)()
~ "\*\*Summary Statistics\*\*"), row_header = "{strata}, n={n}" ) \|\>
\# bold the row headers; print \`x\$table_body\` to see hidden columns
[modify_bold](https://www.danieldsjoberg.com/gtsummary/reference/modify_bold_italic.md)(columns
