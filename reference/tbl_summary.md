...
\# Example 2 ---------------------------------- trial \|\> tbl_summary(
by = trt, include = [c](https://rdrr.io/r/base/c.html)(age, grade,
response, trt), label = [list](https://rdrr.io/r/base/list.html)(age =
"Patient Age"), statistic =
[list](https://rdrr.io/r/base/list.html)([all_continuous](https://www.danieldsjoberg.com/gtsummary/reference/select_helpers.md)()
~ "{mean} ({sd})"), digits =
[list](https://rdrr.io/r/base/list.html)(age =
[c](https://rdrr.io/r/base/c.html)(0, 1)) )

[TABLE]

\# Example 3 ---------------------------------- trial \|\> tbl_summary(
include = [c](https://rdrr.io/r/base/c.html)(age, marker), type =
