...
[add_ci](https://www.danieldsjoberg.com/gtsummary/reference/add_ci.md)(pattern
= "{stat} ({ci})") \|\>
[modify_header](https://www.danieldsjoberg.com/gtsummary/reference/modify.md)(stat_0
= "\*\*Rate (95% CI)\*\*") \|\>
[remove_footnote_header](https://www.danieldsjoberg.com/gtsummary/reference/modify_footnote2.md)(stat_0),
.combine_with = "tbl_stack", .combine_args =
[list](https://rdrr.io/r/base/list.html)(group_header = NULL) ) \|\>
[modify_caption](https://www.danieldsjoberg.com/gtsummary/reference/modify_caption.md)("\*\*Response
Rate by Grade\*\*")
