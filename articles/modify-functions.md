...
- [`modify_column_hide()`](https://www.danieldsjoberg.com/gtsummary/reference/modify_column_hide.md)/[`modify_column_unhide()`](https://www.danieldsjoberg.com/gtsummary/reference/modify_column_hide.md):
...
- [`modify_column_merge()`](https://www.danieldsjoberg.com/gtsummary/reference/modify_column_merge.md)/[`remove_column_merge()`](https://www.danieldsjoberg.com/gtsummary/reference/modify_column_merge.md):
...
- [`modify_bold()`](https://www.danieldsjoberg.com/gtsummary/reference/modify_bold_italic.md)/[`remove_bold()`](https://www.danieldsjoberg.com/gtsummary/reference/modify_bold_italic.md):
  Add/remove bold styling in table cells
- [`modify_italic()`](https://www.danieldsjoberg.com/gtsummary/reference/modify_bold_italic.md)/[`remove_italic()`](https://www.danieldsjoberg.com/gtsummary/reference/modify_bold_italic.md):
...
- [`modify_spanning_header()`](https://www.danieldsjoberg.com/gtsummary/reference/modify.md)/[`remove_spanning_header()`](https://www.danieldsjoberg.com/gtsummary/reference/modify.md):
...
- [`modify_footnote_body()`](https://www.danieldsjoberg.com/gtsummary/reference/modify_footnote2.md)/[`remove_footnote_body()`](https://www.danieldsjoberg.com/gtsummary/reference/modify_footnote2.md):
  Update/remove footnotes corresponding to columns/rows/cells in the
  table
- [`modify_footnote_header()`](https://www.danieldsjoberg.com/gtsummary/reference/modify_footnote2.md)/[`remove_footnote_header()`](https://www.danieldsjoberg.com/gtsummary/reference/modify_footnote2.md):
  Update/remove footnotes corresponding to the table header
- [`modify_footnote_spanning_header()`](https://www.danieldsjoberg.com/gtsummary/reference/modify_footnote2.md)/[`remove_footnote_spanning_header()`](https://www.danieldsjoberg.com/gtsummary/reference/modify_footnote2.md):
...
- [`modify_abbreviation()`](https://www.danieldsjoberg.com/gtsummary/reference/modify_abbreviation.md)/[`remove_abbreviation()`](https://www.danieldsjoberg.com/gtsummary/reference/modify_abbreviation.md):
...
- [`modify_source_note()`](https://www.danieldsjoberg.com/gtsummary/reference/modify_source_note.md)/[`remove_source_note()`](https://www.danieldsjoberg.com/gtsummary/reference/modify_source_note.md):
