...
- When a data frame is passed in the `tbl_summary(percent)` argument,
  the header counts are now tabulated using this data frame.
...
- Adding new function
  [`add_difference_row()`](https://www.danieldsjoberg.com/gtsummary/reference/add_difference_row.md).
...
- Updated the function name of
  [`modify_column_indent()`](https://www.danieldsjoberg.com/gtsummary/reference/deprecated.md)
...
- The
  [`add_ci.tbl_summary()`](https://www.danieldsjoberg.com/gtsummary/reference/add_ci.md)
...
- Updates to the handling of footnotes. Previously, header footnotes
  were handled with
  [`modify_footnote()`](https://www.danieldsjoberg.com/gtsummary/reference/deprecated_modify_footnote.md)
...
- Added S3 methods
  [`add_overall.tbl_hierarchical()`](https://www.danieldsjoberg.com/gtsummary/reference/add_overall.md)
  and
  [`add_overall.tbl_hierarchical_count()`](https://www.danieldsjoberg.com/gtsummary/reference/add_overall.md).
...
- Added
  [`add_stat_label.tbl_ard_summary()`](https://www.danieldsjoberg.com/gtsummary/reference/add_stat_label.md)
...
- Headers in {gt} tables being exported to PDF do not support the `\n`
  ...
  in the
  [`print.gtsummary()`](https://www.danieldsjoberg.com/gtsummary/reference/print_gtsummary.md)
...
- Bug fix in
  [`add_overall.tbl_custom_summary()`](https://www.danieldsjoberg.com/gtsummary/reference/add_overall.md)
...
- The class of
  [`tbl_split()`](https://www.danieldsjoberg.com/gtsummary/reference/deprecated.md)
...
- The default `add_global_p(anova_fun)` argument value has been updated
  to
  [`global_pvalue_fun()`](https://www.danieldsjoberg.com/gtsummary/reference/global_pvalue_fun.md),
...
- The gtsummary selecting functions,
  e.g. [`all_categorical()`](https://www.danieldsjoberg.com/gtsummary/reference/select_helpers.md),
...
- Added
  [`pkgdown_print.gtsummary()`](https://www.danieldsjoberg.com/gtsummary/reference/print_gtsummary.md)
...
- Function
  [`continuous_summary()`](https://www.danieldsjoberg.com/gtsummary/reference/continuous_summary.md)
...
- The checks for `"haven_labelled"` class are now only performed for the
  ...
  [`tbl_uvregression()`](https://www.danieldsjoberg.com/gtsummary/reference/tbl_uvregression.md)
  and
  [`tbl_survfit.data.frame()`](https://www.danieldsjoberg.com/gtsummary/reference/tbl_survfit.md)
...
- Added
  [`tbl_regression.crr()`](https://www.danieldsjoberg.com/gtsummary/reference/tbl_regression_methods.md)
...
- The biggest user-facing change is that the default results for **LaTeX
  ...
  - Special LaTeX characters in the body of the table will be escaped
    with
    [`.escape_latex()`](https://www.danieldsjoberg.com/gtsummary/reference/kableExtra_utils.md)
    or
    [`.escape_latex2()`](https://www.danieldsjoberg.com/gtsummary/reference/kableExtra_utils.md),
...
- **HTML Updates**
  ...
  - Special characters in the table body, headers, spanning headers,
    ...
    [`.escape_html()`](https://www.danieldsjoberg.com/gtsummary/reference/kableExtra_utils.md).
...
- Added new function
  [`modify_column_indent()`](https://www.danieldsjoberg.com/gtsummary/reference/deprecated.md)–a
  wrapper for
  [`modify_table_styling()`](https://www.danieldsjoberg.com/gtsummary/reference/modify_table_styling.md)–to
...
- Now exporting a function primarily used internally as a helper for
  ...
  [`.table_styling_expr_to_row_number()`](https://www.danieldsjoberg.com/gtsummary/reference/dot-table_styling_expr_to_row_number.md).
...
- Fix when using summary type gtsummary selectors
  (e.g. [`all_continuous()`](https://www.danieldsjoberg.com/gtsummary/reference/select_helpers.md))
...
- Now exporting the
  [`.create_gtsummary_object()`](https://www.danieldsjoberg.com/gtsummary/reference/dot-create_gtsummary_object.md)
...
- Fix when
  [`add_overall()`](https://www.danieldsjoberg.com/gtsummary/reference/add_overall.md)
  was run before
  [`add_n()`](https://www.danieldsjoberg.com/gtsummary/reference/add_n.md).
...
- Added
  [`add_overall.tbl_continuous()`](https://www.danieldsjoberg.com/gtsummary/reference/add_overall.md)
...
- Fix in
  [`add_p()`](https://www.danieldsjoberg.com/gtsummary/reference/add_p.md)/[`add_difference()`](https://www.danieldsjoberg.com/gtsummary/reference/add_difference.md)
...
- Added a custom tidier for
  ...
  ([`tbl_regression.gam()`](https://www.danieldsjoberg.com/gtsummary/reference/tbl_regression_methods.md))
...
- Updated[`tbl_merge()`](https://www.danieldsjoberg.com/gtsummary/reference/tbl_merge.md)
  and
  [`tbl_stack()`](https://www.danieldsjoberg.com/gtsummary/reference/tbl_stack.md)
...
- The default value for `include=` argument for the
  [`add_global_p.tbl_regression()`](https://www.danieldsjoberg.com/gtsummary/reference/add_global_p.md)
  and
  [`add_global_p.tbl_uvregression()`](https://www.danieldsjoberg.com/gtsummary/reference/add_global_p.md)
...
- The
  ...
  [`tbl_regression.default()`](https://www.danieldsjoberg.com/gtsummary/reference/tbl_regression.md),
  `tbl_regression.lmer()`, `tbl_regression.glmer()`,
  [`tbl_regression.survreg()`](https://www.danieldsjoberg.com/gtsummary/reference/tbl_regression_methods.md)
...
- The family of
  ...
  - [`tbl_survfit.survfit()`](https://www.danieldsjoberg.com/gtsummary/reference/tbl_survfit.md),
    [`tbl_survfit.list()`](https://www.danieldsjoberg.com/gtsummary/reference/tbl_survfit.md),
    and
    [`tbl_survfit.data.frame()`](https://www.danieldsjoberg.com/gtsummary/reference/tbl_survfit.md)
...
- The header for the `tbl_stack(group_header=)` column is now integrated
  ...
  e.g. [`modify_header()`](https://www.danieldsjoberg.com/gtsummary/reference/modify.md)
  for non-gt output.
...
- No longer checking outcome variable name for consistency in
  [`tbl_regression()`](https://www.danieldsjoberg.com/gtsummary/reference/tbl_regression.md)—only
