...
If you experience issues installing {gt} on Windows, install [Rtools from CRAN](https://cran.r-project.org/bin/windows/Rtools/), restart R, and attempt installation again.  The vignettes hosted on https://cran.r-project.org do not use the {gt} package to print tables.  For examples with {gt}, browse to the {gtsummary} [website](http://www.danieldsjoberg.com/gtsummary/).
