skip_on_cran()
gtsummary:::skip_if_pkg_not_installed(c("huxtable", "withr", "broom.helpers"))
...
test_that("as_hux_table(return_calls) works as expected", {
  ...
  expect_equal(
    names(ht),
    c("tibble", "fmt", "post_fmt", "cols_merge", "cols_hide", "huxtable", "set_left_padding",
...
test_that("as_hux_xlsx works with standard use", {
  gtsummary:::skip_if_pkg_not_installed("openxlsx")
