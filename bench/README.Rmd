...
```{r bench_fetch, echo=TRUE, message=TRUE, warning=TRUE}
...
# stored_benchmarks <- stored_benchmarks = stored_benchmarks
```
...
htmltools::tags$iframe(
  src=file.path(getwd(), "index1.html"),
  width="100%",
  height="600",
  scrolling="no",
  seamless="seamless",
...
```{r include2, echo = FALSE}

htmlwidgets::saveWidget(p2, "index2.html")

htmltools::tags$iframe(
  src=file.path(getwd(), "index2.html"),
  width="100%",
  height="600",
  scrolling="no",
  seamless="seamless",
