...
# TO REVIEW: Some part of the code gives error: "Error: Error in strsplit(x$parent_hashes, " ") : non-character argument" 
# while trying to knit from the github actions (not while runnning locally)
# stored_benchmarks <-
#   stored_benchmarks %>%
#   rowwise() %>%
