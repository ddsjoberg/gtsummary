...
This vignette is meant for those who wish to contribute to gtsummary, or users who wish to gain an understanding of the inner-workings of a gtsummary object so they can more easily modify them to suit their own needs.
If you are a typical user, please refer to the [gtsummary website](http://www.danieldsjoberg.com/gtsummary/) to an introduction on how to use the package's functions and tutorials on advanced use.
