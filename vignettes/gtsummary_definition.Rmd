...
The list contains the following data frames `header`, `footnote`, `footnote_abbrev`, `fmt_fun`, `text_format`, `fmt_missing` and the following objects `source_note`, `caption`, `horizontal_line_above`.
