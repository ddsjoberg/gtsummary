...
tibble::tribble(
  ...
  "gtsummary.add_p.test.continuous2",              "continuous variables with 2-level by variable",
  ...
  "gtsummary.add_p.test.categorical.group2",       "categorical/dichotomous grouped/correlated variables with 2-level by variable",
  "gtsummary.add_p.test.continuous.group2",        "continuous grouped/correlated variables with 2-level by variable"
) %>%
  knitr::kable()
```

For example, to use one-way ANOVA for all continuous variables, use the following options:

```{r}
options(
  gtsummary.add_p.test.continuous2 = "aov",
