...
* Our example dataset has a mix of continuous, binary (0/1), and categorical variables, some with missing data (NA). 
...
1. List variables in a vector, e.g. `age`, `"age"` or `c("age", "stage")`. Variables can be quoted or unquoted.
...
trial %>%
  ...
  tbl_summary(
    by = trt,
    type = list(vars(response, grade) ~ "categorical"), # select by variables in a vector
