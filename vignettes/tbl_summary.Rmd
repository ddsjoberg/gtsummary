...
```{r, include=FALSE}
# on CRAN checks, cannot install a package to default location
# installing to temp dir, and adding the temp directory to the libPath
if(curl::has_internet()) {
  temp_path <- file.path(tempdir(), "gtsummary")
...
```{r,include=FALSE}
# deleting temp dir where gt was installed (this is all for CRAN)
