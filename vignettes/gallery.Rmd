...
[How do I modify statistical column headers in a table?](#table-header)

[How do I modify column headers for grouping variable levels?](#modify-pvalue)

[How do I added a spanning header row to a table?](#table-header)

[How do I change variable (row) labels?](#modify-pvalue)

[How do I italicize or bold labels in a table?](#table-header)

[How do I italicize or bold levels in a table?](#continuous2)

[How do I reduce font size and cell padding in a table?](#side-by-side)

Adding and Modifying Statistics

[How do I add the number of observations to a summary table?](#table-header)

[How do I show additional summary statistics as a new row?](#continuous2)

[How do I include a column for missing (NA) values of a grouping variable?](#include-missing)

[How do I add a column containing the 95% confidence around the mean?](#mean-ci)

[How do I add a column for the difference between groups?](#add_difference)

[How do I summarize a continuous variable by one, two (or more) categorical variables?](#cross_tab_continuous)

[How do I stratify a summary table by more than one variable?](#tbl_strata)

[How do I change the format used for p-values?](#modify-pvalue)

[How do I add a p-value for each group compared to a single reference group?](#compare-to-ref)

[How do I add a correction for multiple testing?](#modify-pvalue)

[How do I combine a summary table with a regression table?](#side-by-side)

Statistical Tests

[How do I do a paired t-test or McNemar's test?](#paired-test)
...
[How do I change the text in a footnote?](#tbl_uvregression-x)

[How do I add significance stars for low p-values?](#add_significance_stars)

[How do I reduce font size and cell padding in a table?](#side-by-side)

Creating and Combining Tables

[How do I combine the results of two related regression models into one table?](#side-by-side)

[How do I combine a regression table with a summary table?](#side-by-side)

[How do I create a regression table for multiple models with the same covariate(s) and different outcomes?](#tbl_uvregression-x)

Adding and Modifying Statistics

[How do I add total event numbers to a regression table?](#add_nevent)

[How do I add event numbers for each level of a categorical covariate?](#add_nevent-levels)

[How do I format a Wald confidence interval?](#wald-ci)
