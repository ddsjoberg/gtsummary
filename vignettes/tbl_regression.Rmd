...
|------------------|-----------------------------------------------------|-------------------------------------------------------------------------------------------|
| p-value          | Formatting and rounding p-values                    | `options(gtsummary.pvalue_fun = function(x) style_pvalue(x, digits = 2)`                  |
| coefficient      | Formatting and rounding for regression coefficients | `options(gtsummary.tbl_regression.estimate_fun = function(x) style_sigfig(x, digits = 3)` |
| confidence level | Set level for limits                                | `options(gtsummary.conf.level = 0.90)`                                                    |
| print engine     | Print tables with `gt` or `kable`                   | `options(gtsummary.print_engine = "kable")`   `options(gtsummary.print_engine = "gt")`    |
