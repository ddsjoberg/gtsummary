...
`gt_calls` is a named list of saved gt function calls.  The gt calls are run when the object is print to the console or in an R markdown document. Here's an example of the first few calls saved with `tbl_regression()`:
