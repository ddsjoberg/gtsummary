...
The following codes show the 1:1 Greedy's nearest neighbor matching without replacement with a caliper of 0.25. 
...
Reference on selecting the appropriate caliper canbe found here : https://doi.org/10.1093/aje/kwt212
...
lm(wt82_71 ~ qsmk, data = df_post_match, weights = weights) %>%
  tbl_regression()
# TODO: update for clusters
```
...
glm(death ~ qsmk,
  ...
  tbl_regression(exponentiate = TRUE)
#TODO: JC to change this to conditional logistic regression.
```
