...
# get a model summary with clustered robust standard errors
tidy_robust(fit1, vcov = "vcovCL", vcov_args = list(cluster = ~matched_group_id))
...
tbl <-
  tbl_regression(
    fit1, 
    tidy_fun = purrr::partial(tidy_robust, vcov = "vcovCL", vcov_args = list(cluster = df_post_match$matched_group_id))
  )
