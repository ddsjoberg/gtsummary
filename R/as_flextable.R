# THIS HELP FILE IS NOT GENERATED BY ROXYGEN2!
# FOLLOW THESE DIRECTIONS WHEN UPDATES ARE MADE.
#
# 1. Delete the existing `as_flextable.gtsummary.Rd` file.
# 2. Document the package which will re-build the `as_flextable.gtsummary.Rd`
#      file with roxygen2
# 3. Open the `as_flextable.gtsummary.Rd` file, and delete the top lines that
#      indicate the file was generated with roxygen2
# 4. In the usage section, replace the line below with the replacement text
#      ORIGINAL LINE
#      as_flextable.gtsummary(
#
#      REPLACEMENT LINE
#      \method{flextable::as_flextable}{gtsummary}(
