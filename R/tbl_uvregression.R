...
tbl_uvregression <- function(data, method, y = NULL, x = NULL, method.args = NULL,
  ...
  include <- var_input_to_string(data = data, var_input = !!rlang::enquo(include))
  exclude <- var_input_to_string(data = data, var_input = !!rlang::enquo(exclude))
  show_single_row <- var_input_to_string(data = data, var_input = !!rlang::enquo(show_single_row))
