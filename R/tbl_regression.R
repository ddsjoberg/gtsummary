...
tbl_regression <- function(x, label = NULL, exponentiate = FALSE,
  ...
  error = function(e) {
    usethis::ui_oops(paste0(
      "{usethis::ui_code('tbl_regression(x)')} utilizes ",
      "{usethis::ui_code('stats::model.frame(x)')} which returned an error\nwhen ",
      "called. This error likely resulted from one of the two sources listed below.\n",
      "One, the object passed in the {usethis::ui_code('x = ')} argument may not be ",
      "a regression model.\nTwo, this error may occur when model objects are created within a ",
