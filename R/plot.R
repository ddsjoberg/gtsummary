...
#' @name plot
#'
#' @examplesIf FALSE && broom.helpers::.assert_package("ggstats", pkg_search = "gtsummary", boolean = TRUE) && broom.helpers::.assert_package("emmeans", pkg_search = "gtsummary", boolean = TRUE)
